...
/**
 * ForgotPasswordForm - Client Component with form UI and local state
 *
 * Handles password reset request with loading/success/error states.
 * Auth check is handled by ForgotPasswordContent wrapper.
 */
